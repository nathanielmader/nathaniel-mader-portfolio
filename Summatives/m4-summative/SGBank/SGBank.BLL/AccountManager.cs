...
{
    //Take what comes in from UI, try to do stuff with repo, make sure rules are applied in right order.
    public class AccountManager
    {
        private IAccountRepository _accountRepository;

        public AccountManager(IAccountRepository accountRepository)//Constructor Injection
        {
